...
// to interact with contract after deploying cntract to goerlli network : npx hardhat run scripts/fly.js --network goerli
const main = async () => {
  fromWei = ethers.utils.formatEther;
  toWei = ethers.utils.parseEther;
  const address = "0x7F7567Fd95AA4e77C7e951EFe54a7395deE327B2"; // address of contract deployed in goerli
  const token = await ethers.getContractAt("VctToken", address);
